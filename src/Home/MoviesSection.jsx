...
// (Same as MovieStreamingSection - UI untouched)
// ==========================================
        ...
        >
          {movies.map((movie) => (
            <SwiperSlide key={movie.id || movie.slug}>
              <MovieReviewCard review={movie} title={title} />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
...
// (Dynamic data logic kept exactly as in original MovieSection)
// ==========================================
const MovieSection = ({ activeItems, newMovies }) => {
  // ✅ QUERY DATA (newMovies prop) logic - same as before, untouched
  ...
  return (
    <div className="bg-[#0f0f0f] pt-12 md:pt-16 pb-8 px-4 md:px-8 ">
              ...
              <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                <div className="grid grid-cols-2 gap-4 pb-20 md:pb-14">
                  {sidebarContent.data.map((movie) => (
                    ...
                    >
                      <MovieReviewCard review={movie} title="Trending Now" />
                    </motion.div>
                  ))}
                </div>
              </div>
