...
const MovieReviewCard = ({ review, title }) => {
  // console.log("Movie ReviewCard", review);
  ...
  const showRating =
    review.movieStatus === "RELEASED" || review.isTheatreReleased === true;

  const isNowShowing =
    review.streamType === "NEW_RELEASE" && review.isTheatreReleased === true;

  const isComingSoon =
    review.streamType === "UPCOMING" && review.isTheatreReleased === false;
  ...
  const shouldShowTheatreCountdown =
    review?.releaseMode === "THEATRICAL" &&
    review?.movieStatus === "WAITING" &&
    !review?.isTheatreReleased &&
    review?.theatreReleaseDate &&
    review?.theatreReleaseDate !== "TBA";
        ...
        {showRating && review.averageRating && (
          <span
            className="absolute top-0  right-0 z-10
               ...
               bg-gradient-to-l from-sky-950/80 to-transparent
  ...
  to-slate-950/95
    ...
    "
        ...
        "
              ...
              <TheatreRunningBadge movie={review} />
            </div>

            {/* RIGHT SIDE - COUNTDOWN */}
            {shouldShowTheatreCountdown && (
              <span
                className="
          theatre-badge
          relative
        ...
        "
              >
                ...
                <LiveRelativeDate targetDate={review.theatreReleaseDate} />
              </span>
            )}
          </div>
        )}
      ...
      <div
        ...
        px-2.5 pt-2 pb-2.5 sm:px-3 sm:pt-2.5 sm:pb-3
    ...
    text-zinc-400"
        ...
        <style jsx="true">{`
          ...
          .cast-marquee {
            display: inline-flex;
            width: max-content;
            animation: castMarquee 35s ease-in-out infinite;
          }
