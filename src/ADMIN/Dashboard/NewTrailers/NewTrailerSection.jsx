...
// import { FaPlus, FaSpinner, FaTrash, FaYoutube } from "react-icons/fa6";
// import { FaEdit } from "react-icons/fa";
// import { Button, Snackbar, Alert } from "@mui/material";
// import NProgress from "nprogress";

// import {
//   deleteTrailerContent,
...
//       dispatch(deleteTrailerContent(id));
//     }
//   };
...
//               <FaYoutube size={20} />
//             </span>
//             Latest Trailers Management
//           </h2>
//           <p className="text-sm text-gray-500 mt-1">
//             Add and manage latest movie trailers with YouTube links
//           </p>
//         </div>
//         <Button
//           variant="contained"
...
//             <p className="text-gray-500 italic">Loading trailers...</p>
//           </div>
//         ) : (
...
//                         {item.postedTimeDisplay}
//                       </td> */}
//                       <td className="px-6 py-4 text-center">
//                         <span
//                           className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${item.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
//                         >
...
// export default NewTrailerSection;
