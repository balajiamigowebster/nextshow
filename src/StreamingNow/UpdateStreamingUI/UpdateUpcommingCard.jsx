  ...
  return (
    <div ref={containerRef} className="overflow-hidden min-w-0 w-full">
      <div
        ref={contentRef}
        className={
          shouldAnimate && isHovered ? "upcoming-genre-marquee" : "inline-flex"
        }
        style={{ "--distance": `${distance}px` }}
      >
        {genres.map((genre) => (
...
const TitleMarquee = ({ title, isHovered }) => {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden min-w-0 w-full">
      <div
        ref={contentRef}
        className={shouldAnimate && isHovered ? "upcoming-title-marquee" : ""}
        style={{ "--distance": `${distance}px` }}
      >
        <h3
  ...
  "
      ...
      "
              >
                ...
                <LiveRelativeDate targetDate={movie.ottReleaseDate} />
              </span>
            )}
          </div>
        )}
    ...
    text-zinc-400"
        ...
        <style jsx="true">{`
          ...
          .upcoming-director-marquee {
            display: inline-flex;
            width: max-content;
            animation: upcomingDirectorMarquee 8s ease-in-out infinite;
          }

          @keyframes upcomingCastMarquee {
            0% {
              transform: translateX(0);
            }
            45% {
          ...
          .upcoming-cast-marquee {
            display: inline-flex;
            width: max-content;
            animation: upcomingCastMarquee 35s ease-in-out infinite;
          }

          @keyframes upcomingGenreMarquee {
            0% {
              transform: translateX(0);
            }
            45% {
          ...
          .upcoming-genre-marquee {
            display: inline-flex;
            width: max-content;
            animation: upcomingGenreMarquee 15s ease-in-out infinite;
          }

          @keyframes upcomingTitleMarquee {
            0% {
              transform: translateX(0);
            }
            45% {
          ...
          .upcoming-title-marquee {
            ...
            width: max-content;
            animation: upcomingTitleMarquee 10s ease-in-out infinite;
          }
